...
type MergeIndexOptions = PagefindIndexOptions & { language?: string;  };

interface PagefindUIOptions extends PagefindIndexOptions {
  element: string;
  pageSize?: number;
  showSubResult?: boolean;
  showImage?: boolean;
  processTerm?: (term: string) => string;
  processResult?: (result: CustomRecord) => CustomRecord;
  ...
  mergeIndex?: MergeIndexOptions &  { bundlePath?: string } [];
}
...
interface Pagefind {
  ...
  debouncedSearch: (term: string, options?: PagefindSearchOptions, debounceTimeoutMs?: number) => Promise<PagefindSearchResults>;
  search: (term: string, options?: PagefindSearchOptions) => Promise<PagefindSearchResults>;
  filters: () => Promise<PagefindFilterCounts>;
  mergeIndex: (bundle: string, options?: MergeIndexOptions) => Promise<void>;
  preload: (term: string, options?: PagefindSearchOptions) => Promise<void>;
  init: () => Promise<void>;
  destroy: () => Promise<void>;
}

export type { PagefindUIOptions, Pagefind, PagefindSearchResult, PagefindSearchFragment };